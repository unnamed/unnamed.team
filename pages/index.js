        ...
        <div className="overflow-y-scroll px-48 py-8 h-full">
          ...
          <main className="h-screen flex flex-col gap-4" id="home">
            ...
            <div className="flex flex-row text-lg gap-4">
              <button
                ...
                onClick={() => window.open('https://github.com/unnamed')}>Show me</button>
              <button
                className="bg-black bg-opacity-30 font-light text-white opacity-90 py-2 px-3 rounded-md hover:bg-opacity-40"
                onClick={() => window.open('https://discord.gg/xbba2fy')}>Join Us</button>
            </div>
          </main>
          ...
          <div className="h-screen flex flex-col gap-8" id="team">
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-white font-light text-lg opacity-90">The people behind the Unnamed Team who make this work</h3>
            </div>
          ...
          <div className="h-screen flex flex-col gap-8" id="about">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-white font-light text-lg opacity-90">This is Unnamed Team, a software development team.
